...
class AlipayPay
{
    ...
    function __construct($order_sn='', $order_amount='', $order_id='123', $action='aliwap')
    {
    ...
    */
    public function p_set() {
        ...
        $option = array(
            'partner'   => '2088131069192620',
            'key'       => 'twgj2xomjyj3yrxgi2fum4lfjrwu0tgr',
            'account'   => '2088131069192620',
        );
        //↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
